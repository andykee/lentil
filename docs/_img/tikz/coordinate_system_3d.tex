...
\begin{tikzpicture}[x={(-0.5cm,-0.4cm)}, y={(0cm,1cm)}, z={(1cm,0cm)}, scale=1]
    ...
    % Aperture plane
    \draw[color=gray] (-1.8,0,0) -- (0,0,\zimg);
    \draw[color=gray] (1.8,0,0) -- (0,0,\zimg);
    \draw[color=gray] (0,-1.8,0) -- (0,0,\zimg);
    \draw[color=gray] (0,1.8,0) -- (0,0,\zimg);

    %\draw[thick, fill=gray, fill opacity=0.1] (0,0) circle [radius=2];
    \draw [thick, fill=gray, fill opacity=0.1, even odd rule] 
        (-2,-2,0) -- (2,-2,0) -- (2,2,0) -- (-2,2,0) -- cycle 
        (0,0) circle[radius=1.8]; 
    \draw[latex-] (-2.5,0,0) node [right] {$x_1$} -- (2.5,0,0);
    ...
    \draw[latex-] (-2.5,0,\zimg) node [right] {$x_2$} -- (2.5,0,\zimg);
