...
class SimpleSegmentedPupil(lentil.Pupil):
    def __init__(self, npix=256):
        segmask1 = lentil.circlemask((npix, npix), 0.2 * npix, shift=(-0.25 * npix, 0.2 * npix))
        segmask2 = lentil.circlemask((npix, npix), 0.2 * npix, shift=(0.25 * npix, 0.2 * npix))
        segmask3 = lentil.circlemask((npix, npix), 0.2 * npix, shift=(0, -0.2 * npix))
